const translations = {
    ...
    ru: {
        ...
        crowdfunding: {
            heroTitle: "Проектный офис НИИ РИТиЦЭ и МИФИ",
            heroSubtitle: "Совместный проектный офис НИИ РИТиЦЭ с Национальным исследовательским ядерным университетом МИФИ для реализации передовых научно-технических проектов.",
            bullet1: "Объединение научного потенциала МИФИ и прикладных исследований НИИ РИТиЦЭ.",
            ...
            detailsDescription: "Проектный офис НИИ РИТиЦЭ совместно с МИФИ реализует комплексные научно-технические проекты в области цифровых технологий, безопасности и инновационных решений для различных отраслей экономики.",
            whyNeeded: "Преимущества сотрудничества",
            whyDescription: "МИФИ обладает мощной научно-исследовательской базой, а НИИ РИТиЦЭ — экспертизой в области практической реализации инновационных решений. Это обеспечивает эффективный трансфер технологий от лаборатории к рынку.",
            forInvestors: "Основные направления деятельности",
            investorBenefits: [
                "Фундаментальные и прикладные исследования в области цифровых технологий и искусственного интеллекта.",
                "Разработка инновационных платформ для цифровой экономики и управления проектами.",
                "Создание систем кибербезопасности и информационной безопасности.",
                "Консалтинг в области цифровой трансформации и внедрения современных решений."
            ],
            ecosystemText: "Проектный офис объединяет научные компетенции МИФИ с практической экспертизой НИИ РИТиЦЭ, что позволяет реализовывать масштабные проекты национального уровня.",
        ...
        contacts: {
            ...
            investmentsDesc: "Совместные проекты с МИФИ",
            press: "Пресс-служба",
